...
export function normalizeDevice(item: DeviceApiItem): DeviceDetail {
  return {
    ...
    status: item.status || item.lifecycleStatus,
    ...
    uploadQueueSize: item.uploadQueueSize ?? undefined,
    uploadLastSuccessAt: item.uploadLastSuccessAt || undefined,
    uploadLastFailedAt: item.uploadLastFailedAt || undefined,
    uploadLastFailureClass: item.uploadLastFailureClass || undefined,
    uploadLastErrorMessage: item.uploadLastErrorMessage || undefined,
    uploadLastReportAt: item.uploadLastReportAt || undefined,
